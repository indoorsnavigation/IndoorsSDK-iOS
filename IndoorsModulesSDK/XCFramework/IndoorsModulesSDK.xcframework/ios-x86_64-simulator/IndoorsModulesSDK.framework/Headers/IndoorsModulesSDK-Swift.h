...
#ifndef INDOORSMODULESSDK_SWIFT_H
#define INDOORSMODULESSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IndoorsModulesSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17IndoorsModulesSDK11HomeBuilder")
@interface HomeBuilder : NSObject
+ (HomeController * _Nonnull)buildWith:(INBuilding * _Nonnull)building SWIFT_WARN_UNUSED_RESULT;
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC17IndoorsModulesSDK14HomeController")
...
@interface HomeController (SWIFT_EXTENSION(IndoorsModulesSDK)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@interface INTasksRequestsBuildingsBuilder : NSObject
+ (INTasksRequestsBuildingsController * _Nonnull)buildWith:(NSArray<INBuilding *> * _Nonnull)buildings SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC17IndoorsModulesSDK34INTasksRequestsBuildingsController")
@interface INTasksRequestsBuildingsController : UIViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

@interface INTasksRequestsBuildingsController (SWIFT_EXTENSION(IndoorsModulesSDK)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
...
@class INRoom;
SWIFT_CLASS("_TtC17IndoorsModulesSDK32INTasksRequestsPlaceOnMapBuilder")
@interface INTasksRequestsPlaceOnMapBuilder : NSObject
+ (UIViewController * _Nonnull)buildWithBuilding:(INBuilding * _Nonnull)building room:(INRoom * _Nullable)room x:(double)x y:(double)y floorId:(double)floorId SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface INTrackingGlobalMapView : INGlobalMapView
/// Create a map based on the INGlobalMapView with configuration for tracking
/// \param frame <code>CGRect</code> size of map view.
///
/// \param trackingService <code>INTrackingService</code> that is responsible for the data.
///
/// \param trackingManager <code>INTrackingObserverDelegate</code> that is delegate the handling of the received messages.
///
...
- (nonnull instancetype)initWithConfiguration:(INMapViewsConfiguration * _Nonnull)configuration SWIFT_UNAVAILABLE;
@end
...
@class UITab;
SWIFT_CLASS("_TtC17IndoorsModulesSDK26INTrackingTabBarController")
@interface INTrackingTabBarController : UITabBarController <INBaseMapViewDelegate>
- (nonnull instancetype)initWithCurrentBuilding:(INBuilding * _Nonnull)currentBuilding OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
